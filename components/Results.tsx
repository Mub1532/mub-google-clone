...
function Results({ results }: any) {
    return <div className="flex flex-col text-xs md:text-sm lg:text-base dark:text-zinc-400 mx-auto p-2 px-4 md:pl-40">
        <div className="mb-4 text-zinc-500">Around {results.searchInformation?.formattedTotalResults} results. Took {results.searchInformation.formattedSearchTime} seconds Note: Results come from Googles official API</div>
